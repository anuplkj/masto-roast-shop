...
export default function ProductImage({ className = "", label }: Props) {
  return (
    <div
      className={`relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-beige to-secondary ${className}`}
    >
